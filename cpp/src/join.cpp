                  ...
                  int _num_partitions)
{
  ...
  if (_num_partitions != -1 && broadcast == BroadcastInput::AUTO) {
    ...
    argument::add_next_input(task, rhs, rhs_constraints);
