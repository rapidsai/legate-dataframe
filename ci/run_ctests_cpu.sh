...
legate ./cpp_tests --output-on-failure --no-tests=error "$@" --gtest_filter="*CSV*:*Binary*:*Parquet*:*NullOps*:*Unary*:*Reduction*:*Sort*:*Compaction*:*GroupBy*:*Join*:*Contains*:*StringsTest*"
